        ...
        const fetchImage = async()=>{
            try{
                ...
                if(result &&result.response){
                    ...
                    console.error("Failed to get image frm unsplash")
                }
            }catch(error){
                console.log(error)
            ...
            <div className="grid grid-cols-3 gap-2 mb-2">
                {images.map((image)=>(
                    ...
                    onClick={()=>{
                        ...
                        <input type="radio" id={id} name={id} className='hidden' 
                        ...
                        w-full text-[10px] truncate text-white hover:underline p-1 bg-black/50'>
                            {image.user.name}
                        </Link>
                    </div>
                ))}
