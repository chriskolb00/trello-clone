        ...
        <div className="flex items-start gap-x-3 mb-6 w-full">
            ...
            <div className="w-full">
                <form action={onSubmit}>
                    <FormInput ref={inputRef} onBlur={onBlur}
                    id="title" defaultValue={title} 
                ...
                <p className="font-gray-400 text-sm text-muted-foreground">
                    <span className="underline">{data.list.title}</span> list
                </p>
            </div>
        </div>
    )
